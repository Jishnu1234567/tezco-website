...
const TECH_ICONS: { label: string; color: string; svg: string }[] = [
  ...
  },
  {
    label: "Node.js",
    color: "#5FA04E",
    svg: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M11.998 24c-.321 0-.641-.084-.922-.247l-2.936-1.737c-.438-.245-.224-.332-.08-.383.585-.203.703-.25 1.328-.605.065-.037.151-.023.218.017l2.256 1.339c.082.045.198.045.275 0l8.795-5.076c.082-.047.134-.141.134-.238V6.921c0-.099-.053-.192-.137-.242l-8.791-5.072c-.081-.047-.189-.047-.271 0L3.075 6.68c-.084.05-.139.144-.139.243v10.148c0 .097.055.191.137.237l2.409 1.391c1.307.654 2.108-.116 2.108-.891V7.787c0-.142.114-.253.256-.253h1.115c.139 0 .255.112.255.253v10.021c0 1.745-.95 2.745-2.604 2.745-.508 0-.909 0-2.026-.551L2.28 18.675c-.57-.329-.922-.943-.922-1.604V6.921c0-.661.353-1.275.922-1.603l8.795-5.082c.557-.315 1.296-.315 1.848 0l8.794 5.082c.57.329.924.944.924 1.603v10.15c0 .661-.354 1.275-.924 1.604l-8.794 5.078c-.28.162-.6.247-.925.247zm2.718-7.003c-3.853 0-4.662-1.769-4.662-3.254 0-.142.114-.253.256-.253h1.138c.127 0 .233.091.252.215.172 1.161.686 1.747 3.016 1.747 1.855 0 2.645-.42 2.645-1.405 0-.568-.225-.99-3.114-1.273-2.416-.238-3.908-.77-3.908-2.7 0-1.778 1.499-2.838 4.013-2.838 2.823 0 4.222.98 4.4 3.088.006.07-.019.138-.065.189a.252.252 0 0 1-.185.081h-1.143a.25.25 0 0 1-.247-.205c-.276-1.224-.946-1.616-2.76-1.616-2.033 0-2.27.708-2.27 1.238 0 .643.28.83 3.02 1.193 2.708.36 4.001.87 4.001 2.765 0 1.917-1.598 3.028-4.387 3.028z"/></svg>`,
  },
  {
    label: "PostgreSQL",
    color: "#4169E1",
    svg: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M17.128 0a10.134 10.134 0 0 0-2.755.403l-.063.02A10.922 10.922 0 0 0 12.6.258C11.422.238 10.41.524 9.594 1 8.79.721 7.122.24 5.364.336 4.24.403 2.986.727 2.03 1.661.833 2.82.214 4.601.5 6.868c.09.71.271 1.374.56 1.962a3.174 3.174 0 0 0-.085.779c.007.701.183 1.401.392 2.062.392 1.24.93 2.41 1.835 3.087.69.516 1.46.773 2.182.773.316 0 .63-.052.926-.16.378-.14.7-.374.979-.651.137.12.282.23.44.322 1.17.69 2.755.627 3.879.01a4.272 4.272 0 0 0 .441-.324c.28.28.605.517.988.657.3.11.617.161.934.161.722 0 1.492-.257 2.182-.773.905-.677 1.443-1.847 1.835-3.087.21-.661.386-1.361.392-2.062a3.215 3.215 0 0 0-.083-.778c.288-.589.47-1.252.56-1.962.285-2.267-.334-4.048-1.53-5.207C20.68.656 19.05.164 17.807.114A8.027 8.027 0 0 0 17.128 0zm.22 1.227c.075.008.149.018.224.028 1.037.144 2.395.538 3.259 1.866 1.088 1.667.796 3.861.518 5.008l-.012.053-.004.045c-.09.866-.313 1.578-.638 2.135l-.144.247.088.27c.115.354.14.741.135 1.123-.007.543-.157 1.133-.347 1.728-.338 1.067-.84 2.073-1.469 2.545-.544.407-1.118.614-1.652.614a2.04 2.04 0 0 1-.55-.074c-.576-.174-1.01-.622-1.36-1.168l-.35-.54-.407.502a3.017 3.017 0 0 1-.762.636c-.782.449-1.954.49-2.77.011a2.955 2.955 0 0 1-.757-.637l-.405-.504-.351.542c-.35.546-.785.993-1.362 1.167a2.04 2.04 0 0 1-.548.074c-.535 0-1.11-.207-1.653-.614-.628-.472-1.13-1.478-1.47-2.545-.19-.595-.34-1.185-.346-1.728-.006-.382.02-.769.135-1.123l.088-.27-.144-.247c-.325-.557-.549-1.269-.638-2.135l-.004-.045-.012-.053c-.278-1.147-.57-3.34.518-5.008.864-1.328 2.222-1.722 3.259-1.866a6.99 6.99 0 0 1 1.433-.038c.613.052 1.187.176 1.657.315l.543.16.4-.393c.403-.396.824-.64 1.41-.761a4.835 4.835 0 0 1 1.319-.132c.16.009.317.025.474.048zm-3.01 1.352a4.87 4.87 0 0 0-.612.046c-.797.098-1.416.385-1.934.814.078.042.157.08.235.127 1.08.654 1.744 1.672 1.744 2.709v.002c.005 1.267-.85 2.414-2.204 3.04a5.79 5.79 0 0 1-2.315.509h-.038c-.638-.005-1.42-.15-2.077-.479-.13-.064-.259-.128-.38-.2-.06.13-.117.264-.168.403-.242.672-.281 1.373-.226 2.045.043.529.157 1.051.313 1.548.34 1.07.853 2.082 1.469 2.541.344.257.71.387 1.065.387a.966.966 0 0 0 .26-.034c.332-.1.623-.38.894-.792l.762-1.178.804.99c.351.432.652.668.997.748a1.33 1.33 0 0 0 .31.037c.47.004.976-.207 1.476-.53l-.061-.126c-.18-.372-.291-.83-.277-1.338.01-.38.093-.823.311-1.23l.14-.26-.169-.239c-.457-.648-.68-1.408-.648-2.105.037-.793.374-1.444.878-1.877l.13-.11.026-.169c.06-.395.27-.759.586-1.079.447-.45 1.093-.784 1.868-.96a4.86 4.86 0 0 1 .972-.114c.34 0 .672.04.97.116l.005-.026c.245-1.147.17-2.217-.248-2.927-.52-.89-1.53-1.3-2.881-1.408a6.128 6.128 0 0 0-.796-.01z"/></svg>`,
  },
  {
    label: "Redis",
    color: "#FF4438",
    svg: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M10.9 4.8L7.5 6.4l3.4 1.6 3.4-1.6-3.4-1.6zm-4.9 2.3l3.4 1.6v3.2L6 10.3V7.1zm4.9 4.8l-3.4-1.6v3.2l3.4 1.6 3.4-1.6v-3.2l-3.4 1.6zm4.9-3.2L12.3 10v3.2l3.5-1.6V7.7zM0 2.7v18.6L12 24l12-2.7V2.7L12 0 0 2.7zm21.8 15.5L12 20.4l-9.8-2.2V4.7L12 2.5l9.8 2.2v13.5z"/></svg>`,
  },
  {
    label: "Docker",
    color: "#2496ED",
  ...
  },
  {
    label: "Vite",
    color: "#646CFF",
    svg: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M0 0l10.594 18.489L24 0h-4.703L10.594 13.011 4.703 0H0z"/><path d="M10.594 18.489L0 0h4.703L10.594 13.011 20.297 0 24 0 10.594 18.489z" opacity=".7"/></svg>`,
  },
  {
    label: "Firebase",
    color: "#FFCA28",
  ...
  },
  {
    label: "WebGL",
    color: "#990000",
    svg: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm.537 5.348l5.332 9.228-2.31.005-2.046-3.541-2.046 3.541-2.31-.005zm-5.869 9.228L4.357 7.348h2.31l2.047 3.541 2.047-3.541h2.309l-2.309 4.004-2.309 4.004-.004.006h-2.313l1.533-4.786z"/></svg>`,
  },
];
...
export default function ModernEffectsPage() {
  ...
  useEffect(() => {
    if (isLoading) return;
    const speed1 = 7.6; // px/frame row 1 (left)
    const speed2 = 7.45; // px/frame row 2 (right, reversed)
    ...
    const animate = () => {
      if (track1Ref.current) {
        ...
        track1Ref.current.style.transform = `translateX(${x1.current}px)`;
      }
      if (track2Ref.current) {
        const half = track2Ref.current.scrollWidth / 2;
        x2.current += speed2;
        if (x2.current >= 0) x2.current = -half;
        track2Ref.current.style.transform = `translateX(${x2.current}px)`;
      }
      raf.current = requestAnimationFrame(animate);
    };

    // Start row 2 at -half so it begins scrolled
    if (track2Ref.current) {
      x2.current = -(track2Ref.current.scrollWidth / 2);
    }
  ...
  // ── Icon chip component ────────────────────────────────────────────────────
  const IconChip = ({ item, accent }: { item: typeof TECH_ICONS[0]; accent: string }) => (
    <div className="flex items-center gap-2.5 mx-3 md:mx-5 shrink-0 cursor-default group">
      <div
        className="flex items-center gap-2.5 px-4 py-2 rounded-full border border-white/10 bg-white/[0.04] backdrop-blur-sm
          group-hover:border-white/25 group-hover:bg-white/10 transition-all duration-300"
      >
        {/* Real SVG icon tinted to brand color */}
        <span
          className="shrink-0 transition-all duration-300"
          style={{ color: item.color, width: 18, height: 18, display: "inline-flex", alignItems: "center" }}
          dangerouslySetInnerHTML={{ __html: item.svg }}
          aria-hidden
        />
        <span
          className="font-semibold uppercase tracking-widest text-gray-400 group-hover:text-white transition-colors duration-300"
          style={{ fontSize: "clamp(8px,1.1vw,11px)", whiteSpace: "nowrap" }}
        >
          {item.label}
        </span>
      </div>
  ...
  const reversed = [...TECH_ICONS].reverse();
  ...
  return (
    <div ref={containerRef} className="relative bg-[#050505] text-white overflow-x-hidden" style={{ fontFamily: "'Archivo',sans-serif" }}>
      <style dangerouslySetInnerHTML={{
        ...
        @media (prefers-reduced-motion: reduce) { .marquee-track-wrap * { animation: none !important; } }
      `}} />
      ...
      <section className="bg-[#050505] py-20 md:py-32 overflow-hidden">
        ...
        {/* Row 1 — RAF driven, left scroll */}
        <div className="relative overflow-hidden mb-4 marquee-track-wrap">
          ...
          <div
            ...
            style={{ width: "max-content", transform: "translateX(0)" }}
          >
            {/* triple-duplicate for seamless loop at any screen size */}
            {[...TECH_ICONS, ...TECH_ICONS, ...TECH_ICONS].map((item, i) => (
              <IconChip key={i} item={item} accent="cyan" />
            ))}
          </div>
        </div>

        {/* Row 2 — RAF driven, right scroll, reversed order */}
        <div className="relative overflow-hidden marquee-track-wrap">
          <div className="absolute left-0 top-0 bottom-0 w-20 md:w-40 z-10 pointer-events-none"
            style={{ background: "linear-gradient(to right,#050505,transparent)" }} />
          <div className="absolute right-0 top-0 bottom-0 w-20 md:w-40 z-10 pointer-events-none"
            style={{ background: "linear-gradient(to left,#050505,transparent)" }} />
          ...
          >
            {[...reversed, ...reversed, ...reversed].map((item, i) => (
              <IconChip key={i} item={item} accent="blue" />
            ))}
          </div>
        </div>
